...
def integers(sequence_of_sequences):
    ...
    for k in range(len(sequence_of_sequences)):
        for m in range(len(sequence_of_sequences[k])):
            if type(sequence_of_sequences[k][m]) is int:
                new.append(sequence_of_sequences[k][m])
    return new
...
def big_letters(sequence_of_sequences):
    ...
    for k in range(len(sequence_of_sequences)):
        if type(sequence_of_sequences[k]) is str:
            for m in range(len(sequence_of_sequences[k])):
                if sequence_of_sequences[k][m].isupper():
                    new += sequence_of_sequences[k][m]
    return new
